...
public class Salad {
    ...
    public void delete(int index){listOfVegetables.remove(index);}

    public int size(){return listOfVegetables.size();}

    public int getId() {return id;}

    public void setId(int id) {this.id = id;}

    public String getBoxForm() {return BoxForm;}

    public void setBoxForm(String boxForm) {BoxForm = boxForm;}
